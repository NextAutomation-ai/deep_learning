    ...
    .values([
      {
        ...
        options: JSON.stringify(["The mean of a dataset", "Conditional probability P(Y|X) from P(X|Y), P(Y) and P(X)", "The variance of a distribution", "The gradient of a loss function"]),
      ...
      },
      {
        ...
        options: JSON.stringify(["Features are correlated", "Features are conditionally independent given the class", "All features have equal weight", "The data is normally distributed"]),
      ...
      },
      {
        ...
        options: JSON.stringify(["The number of features", "The distance between points and their assigned cluster centroids", "The probability of each class", "The depth of a decision tree"]),
      ...
      },
      {
        ...
        options: JSON.stringify(["Convergence is guaranteed", "The algorithm diverges and overshoots the minimum", "Training becomes faster with no downside", "The model underfits"]),
      ...
      },
      {
        ...
        options: JSON.stringify(["Find the optimal margin", "Converge in finite steps", "Minimize the squared error", "Cluster the data"]),
    ...
    .values([
      {
        ...
        options: JSON.stringify(["1 year", "10 years", "30 years", "100 years"]),
      ...
      },
      {
        ...
        options: JSON.stringify(["Carbon dioxide (CO2)", "Methane (CH4)", "Nitrogen (N2)", "Nitrous oxide (N2O)"]),
      ...
      },
      {
        ...
        options: JSON.stringify(["They produce the most emissions", "They depend on climate-sensitive resources and lack adaptive capacity", "They live only in cold regions", "They refuse to adopt new technology"]),
      ...
      },
      {
        ...
        options: JSON.stringify(["Mitigation reduces GHG emissions; adaptation adjusts to impacts", "They are the same thing", "Mitigation adjusts to impacts; adaptation reduces emissions", "Mitigation is local; adaptation is global"]),
      ...
      },
      {
        ...
        options: JSON.stringify(["Only technology solutions", "Values, attitudes, and behaviours for sustainability", "Memorizing emission statistics", "Political party alignment"]),
